...
\newcommand\w{60}   % square length
\newcommand\h{60}   % square length
...
\pgfmathsetmacro\textYPose{\h*-0.1}
...
\pgfmathsetmacro\lineWidth{\w*0.5}
\draw[|<->|] (\w*1.25, -\h*0.25) -- node[below, font=\footnotesize]{\lineWidth $mm$} ++(\lineWidth, 0);
\end{tikzpicture}
